...
export const procedureFilterSpec: CollectionFilterSpec = {
  ...
  fields: [
    { name: 'authorityCui', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'p', column: 'authority_cui' } },
    { name: 'cpvCode', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'p', column: 'cpv_code' } },
    { name: 'cpvCodePrefix', type: 'string', ops: ['prefix'], column: { alias: 'p', column: 'cpv_code' }, description: 'Left-anchored CPV prefix (uses procedures_cpv_code_idx).' },
    // cpvDivision[] is repo-intercepted → index-safe range (virtual; not compiled).
    { name: 'cpvDivision', type: 'string', ops: ['in', 'eq'], array: true, virtual: true, column: { alias: 'p', column: 'cpv_code' }, description: '2-digit CPV division (index-safe range on cpv_code, not substring).' },
    { name: 'procedureType', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'p', column: 'procedure_type' } },
    { name: 'contractKind', type: 'string', ops: ['eq', 'in'], array: true, column: { alias: 'p', column: 'contract_kind' } },
    { name: 'noticeKind', type: 'string', ops: ['eq', 'in'], array: true, column: { alias: 'p', column: 'notice_kind' } },
    { name: 'status', type: 'enum', ops: ['eq', 'in'], array: true, enumValues: PROCEDURE_STATUSES, column: { alias: 'p', column: 'status' } },
    { name: 'noticeNo', type: 'string', ops: ['eq'], column: { alias: 'p', column: 'notice_no' } },
    { name: 'year', type: 'int', ops: ['eq', 'in', 'between'], virtual: true, column: { alias: 'p', column: 'publication_date' }, description: 'Filter on publication_date year (repo expands to a date range on the index).' },
    { name: 'publicationDate', type: 'date', ops: ['between'], column: { alias: 'p', column: 'publication_date' } },
    { name: 'minValueRon', type: 'money', ops: ['gte'], column: { alias: 'p', column: 'estimated_value_ron' }, description: 'Lower bound on estimated_value_ron.' },
    { name: 'maxValueRon', type: 'money', ops: ['lte'], column: { alias: 'p', column: 'estimated_value_ron' }, description: 'Upper bound on estimated_value_ron.' },
    // buyer territory (needs the core join)
    { name: 'countyCode', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 't', column: 'county_code' }, description: 'Buyer county (via core join).' },
    { name: 'region', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 't', column: 'region' }, description: 'Buyer region (via core join).' },
  ],
...
export const contractFilterSpec: CollectionFilterSpec = {
  ...
  fields: [
    { name: 'authorityCui', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'c', column: 'authority_cui' } },
    { name: 'supplierCui', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'c', column: 'supplier_cui' } },
    { name: 'cpvCode', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'c', column: 'cpv_code' } },
    { name: 'cpvCodePrefix', type: 'string', ops: ['prefix'], column: { alias: 'c', column: 'cpv_code' }, description: 'Left-anchored CPV prefix (uses contracts_cpv_code_idx).' },
    { name: 'cpvDivision', type: 'string', ops: ['in', 'eq'], array: true, virtual: true, column: { alias: 'c', column: 'cpv_code' }, description: '2-digit CPV division (index-safe range on cpv_code).' },
    { name: 'status', type: 'enum', ops: ['eq', 'in'], array: true, enumValues: CONTRACT_STATUSES, column: { alias: 'c', column: 'status' } },
    { name: 'noticeNo', type: 'string', ops: ['eq'], column: { alias: 'c', column: 'notice_no' } },
    { name: 'procedureId', type: 'string', ops: ['eq', 'isNull'], column: { alias: 'c', column: 'procedure_id' }, description: 'isNull surfaces procedures-without-linkage (PC-10).' },
    { name: 'year', type: 'int', ops: ['eq', 'in', 'between'], virtual: true, column: { alias: 'c', column: 'contract_date' }, description: 'Filter on contract_date year (repo expands to a date range).' },
    { name: 'contractDate', type: 'date', ops: ['between'], column: { alias: 'c', column: 'contract_date' } },
    { name: 'minValueRon', type: 'money', ops: ['gte'], column: { alias: 'c', column: 'value_ron' } },
    { name: 'maxValueRon', type: 'money', ops: ['lte'], column: { alias: 'c', column: 'value_ron' } },
    { name: 'includeDuplicates', type: 'bool', ops: ['eq'], virtual: true, column: { alias: 'c', column: 'is_canonical' }, description: 'Default false → forces is_canonical=true; true also returns non-canonical rows.' },
    { name: 'countyCode', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 't', column: 'county_code' }, description: 'Buyer county (via core join).' },
    { name: 'region', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 't', column: 'region' }, description: 'Buyer region (via core join).' },
  ],
...
export const daFilterSpec: CollectionFilterSpec = {
  ...
  fields: [
    { name: 'authorityCui', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'd', column: 'authority_cui' } },
    { name: 'supplierCui', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'd', column: 'supplier_cui' } },
    { name: 'cpvCode', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'd', column: 'cpv_code' } },
    { name: 'cpvCodePrefix', type: 'string', ops: ['prefix'], column: { alias: 'd', column: 'cpv_code' }, description: 'Left-anchored CPV prefix (uses das_cpv_code_idx).' },
    { name: 'cpvDivision', type: 'string', ops: ['in', 'eq'], array: true, virtual: true, column: { alias: 'd', column: 'cpv_code' }, description: '2-digit CPV division (index-safe range on cpv_code).' },
    { name: 'uniqueCode', type: 'string', ops: ['eq'], column: { alias: 'd', column: 'unique_code' } },
    { name: 'sourceSystem', type: 'enum', ops: ['eq', 'in'], array: true, enumValues: DA_SOURCE_SYSTEMS, column: { alias: 'd', column: 'source_system' } },
    { name: 'status', type: 'enum', ops: ['eq', 'in'], array: true, enumValues: DA_STATUSES, column: { alias: 'd', column: 'status' } },
    // NOTE: elicitatie_da publication_date is 100% null → the date filter binds to
    // finalization_date (the indexed, populated column).
    { name: 'year', type: 'int', ops: ['eq', 'in', 'between'], virtual: true, column: { alias: 'd', column: 'finalization_date' }, description: 'Filter on finalization_date year (publication_date is null on elicitatie_da).' },
    { name: 'finalizationDate', type: 'date', ops: ['between'], column: { alias: 'd', column: 'finalization_date' } },
    { name: 'minValueRon', type: 'money', ops: ['gte'], column: { alias: 'd', column: 'value_ron' } },
    { name: 'maxValueRon', type: 'money', ops: ['lte'], column: { alias: 'd', column: 'value_ron' } },
    { name: 'includeDuplicates', type: 'bool', ops: ['eq'], virtual: true, column: { alias: 'd', column: 'is_canonical' }, description: 'Default false → forces is_canonical=true.' },
  ],
...
export const modificationFilterSpec: CollectionFilterSpec = {
  ...
  fields: [
    { name: 'contractId', type: 'string', ops: ['eq', 'isNull'], column: { alias: 'm', column: 'contract_id' }, description: 'isNull surfaces modifications without a linked contract (PC-10).' },
    { name: 'authorityCui', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'm', column: 'authority_cui' } },
    { name: 'supplierCui', type: 'string', ops: ['in', 'eq'], array: true, column: { alias: 'm', column: 'supplier_cui' } },
    { name: 'contractNo', type: 'string', ops: ['eq'], column: { alias: 'm', column: 'contract_no' } },
    { name: 'noticeNo', type: 'string', ops: ['eq'], column: { alias: 'm', column: 'notice_no' } },
    { name: 'linkMethod', type: 'string', ops: ['eq', 'in', 'isNull'], array: true, column: { alias: 'm', column: 'link_method' } },
    { name: 'modificationType', type: 'string', ops: ['eq', 'in'], array: true, column: { alias: 'm', column: 'modification_type' } },
    { name: 'year', type: 'int', ops: ['eq', 'in', 'between'], column: { alias: 'm', column: 'year' } },
    { name: 'modificationDate', type: 'date', ops: ['between'], column: { alias: 'm', column: 'modification_date' } },
  ],
