/**
 * UAT Analytics Module - Domain Errors
 *
 * Error types for UAT heatmap analytics operations.
 */
...
/**
 * Discriminated union of all UAT analytics errors.
 */
export type UATAnalyticsError =
...
export const createMissingRequiredFilterError = (field: string): MissingRequiredFilterError => ({
  ...
  field,
  message: `${field} is required for heatmap data`,
});
