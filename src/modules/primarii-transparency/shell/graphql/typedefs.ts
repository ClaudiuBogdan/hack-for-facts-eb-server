...
enum PrimariiStatGroupBy { county region data_quality_status result_status entity_type }
enum PrimariiResolveDim { entity county status siruta }
...
type PrimariiResolveHit { kind: String!  value: String!  label: String!  score: Float  hint: String }
...
type PrimariiDocumentEdge { node: PrimariiDocument!  cursor: String! }
...
type PrimariiSalaryClaimEdge { node: PrimariiSalaryClaim!  cursor: String! }
...
type PrimariiSnapshotEdge { node: PrimariiSnapshot!  cursor: String! }

${filterInputs}

extend type Query {
  primariiEntities(filter: PrimariiEntityFilter, first: Int = 20, after: String, sort: PrimariiEntitySortKey): PrimariiEntityConnection!
  ...
  primariiEntitySalaryClaims(cui: CUI!, first: Int = 20, after: String): PrimariiSalaryClaimConnection!
  primariiDocuments(filter: PrimariiDocumentFilter!, first: Int = 20, after: String): PrimariiDocumentConnection!
  ...
  primariiLoadIssues(cui: CUI, severity: String, issueCode: String, limit: Int = 50): [PrimariiLoadIssue!]!
