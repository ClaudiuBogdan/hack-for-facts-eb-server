...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `pinned`     | `key` (case), exact `path`, `kind` ∈ `value-change` / `null-change` / `array-length`, `before`+`after` **or** `beforeSha256`+`afterSha256`, `reason`                                                          | exactly one difference of one case, with those values                                        | one-offs                                                                                                                  |
